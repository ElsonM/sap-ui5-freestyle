...
description: Behavior Definition (BDEF) specialist. Use when creating RAP behavior definitions - managed/unmanaged scenarios, draft handling, validations, determinations, and actions.
