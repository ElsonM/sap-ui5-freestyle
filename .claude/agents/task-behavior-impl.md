...
description: RAP Behavior Implementation specialist. Use when creating behavior pool classes (ZBP_AI_*) with local handler/saver classes using EML (Entity Manipulation Language).
