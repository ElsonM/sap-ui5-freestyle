...
description: DCL Access Control specialist. Use when implementing row-level authorization (DCL sources) for CDS views, including PFCG authorization object checks.
