---
name: sap-research
description: SAP Clean Core and cloud readiness compliance expert. Use to review ABAP code for clean core compliance, identify non-released API usage, and research cloud-ready released API alternatives.
tools: Read, Grep, Glob, mcp__abap-mcp__GetObjectInfo, mcp__abap-mcp__SearchObject, mcp__abap-mcp__WhereUsedSearch, mcp__abap-mcp__data_preview, mcp__abap-mcp__sap_help_search, mcp__abap-mcp__sap_help_get, mcp__abap-mcp__sap_community_search
---
