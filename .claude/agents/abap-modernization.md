...
description: Legacy ABAP modernization planner. Use to analyze legacy programs for obsolete syntax, deprecated APIs, and cloud-readiness blockers, and to produce actionable modernization plans.
