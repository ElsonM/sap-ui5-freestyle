---
name: amdp
description: AMDP and SQLScript specialist. Use for ABAP Managed Database Procedures, CDS table functions, HANA pushdown, and performance-critical database logic.
