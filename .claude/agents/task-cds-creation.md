...
description: CDS View Entity specialist. Use when creating CDS view entities, associations, compositions, projections, analytical or hierarchy views, and CDS annotations for RAP applications.
tools: Read, Grep, Glob, mcp__abap-mcp__GetObjectInfo, mcp__abap-mcp__SearchObject, mcp__abap-mcp__WhereUsedSearch, mcp__abap-mcp__data_preview, mcp__abap-mcp__sap_help_search, mcp__abap-mcp__sap_help_get, mcp__abap-mcp__sap_community_search, mcp__abap-mcp__CreateAIObject, mcp__abap-mcp__ChangeAIObject, mcp__abap-mcp__ActivateObject
---
