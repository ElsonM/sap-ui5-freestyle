---
name: rap-analysis
description: RAP application planning specialist. Use when designing or planning end-to-end RESTful ABAP Programming Model (RAP) applications - CDS architecture, behavior definitions, draft handling, OData exposure, Fiori Elements. Produces implementation plans; the main conversation then runs the task-* agents in sequence.
tools: Read, Grep, Glob, WebFetch, WebSearch, TodoWrite, mcp__abap-mcp__GetObjectInfo, mcp__abap-mcp__SearchObject, mcp__abap-mcp__WhereUsedSearch, mcp__abap-mcp__data_preview, mcp__abap-mcp__sap_help_search, mcp__abap-mcp__sap_help_get, mcp__abap-mcp__sap_community_search
---
