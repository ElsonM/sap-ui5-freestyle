...
description: Fiori UI Metadata Extension specialist. Use when creating DDLX metadata extensions with @UI annotations for List Report and Object Page layouts.
