...
1. **SAP Help Search** → Research modern APIs
2. **Change Object** → Refactor code
3. **Activate** → Verify syntax
...
- [AGENTS.md](../../AGENTS.md) - Workspace instructions and agent index (GitHub Copilot and other agents)
- [CLAUDE.md](../../CLAUDE.md) - Workspace instructions for Claude Code
- [.github/agents/](../agents/) - Specialized ABAP agent definitions
